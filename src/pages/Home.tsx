...
// Import images correctly (match actual file names)
import MarineGradeRope from "../components/assets/MarineGradeRope.jpeg";
import PPBraidedRope from "../components/assets/PPBraidedRope.jpeg";
import PPTwine from "../components/assets/PPTwine.jpeg";
import TwistedRope from "../components/assets/twisted-rope.jpg";
  ...
  const products = [
    {
      ...
      description:
        "High-strength polypropylene twisted rope ideal for marine and industrial applications.",
      image: TwistedRope,
    ...
    },
    {
      ...
      description:
        "Durable braided rope with excellent grip and flexibility for various applications.",
      image: PPBraidedRope,
    ...
    },
    {
      ...
      name: "PP Twine",
      description:
        "Premium quality twine perfect for packaging, bundling, and agricultural use.",
      image: PPTwine,
    ...
    },
    {
      ...
      description:
        "UV-resistant rope designed specifically for marine environments and harsh conditions.",
      image: MarineGradeRope,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-lg">
                Leading manufacturer of high-quality polypropylene ropes and
                twines. Trusted by industries worldwide for strength, durability,
                and reliability.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive selection of premium PP ropes and twines designed for
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Contact us today for custom quotes, bulk orders, and specialized rope
